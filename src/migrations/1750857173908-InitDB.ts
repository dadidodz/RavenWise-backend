...
export class InitDB1750857173908 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "lessons" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255) NOT NULL, "content" text, "estimated_duration" integer NOT NULL, "type" text NOT NULL, "chapterId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_exercices" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "startingCode" text, "solution" text NOT NULL, "content" text NOT NULL, "deposit" text, "lessonId" integer, CONSTRAINT "FK_814227fe802aef196bd49975c43" FOREIGN KEY ("lessonId") REFERENCES "lessons" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_exercices"("id", "startingCode", "solution", "content", "deposit", "lessonId") SELECT "id", "startingCode", "solution", "content", "deposit", "lessonId" FROM "exercices"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_publications" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255) NOT NULL, "description" text NOT NULL, "category" varchar CHECK( "category" IN ('web development','framework','programming','data science','mobile development','design') ) NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "authorClerkId" varchar NOT NULL, CONSTRAINT "FK_57f192cb5f64a58247f4c274b4f" FOREIGN KEY ("authorClerkId") REFERENCES "users" ("clerkId") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exercices" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "startingCode" text, "solution" text NOT NULL, "content" text NOT NULL, "deposit" text, "lessonId" integer)`);
        await queryRunner.query(`INSERT INTO "exercices"("id", "startingCode", "solution", "content", "deposit", "lessonId") SELECT "id", "startingCode", "solution", "content", "deposit", "lessonId" FROM "temporary_exercices"`);
