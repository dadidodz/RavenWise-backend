...
export class InitDB1751021181890 implements MigrationInterface {
    name = 'InitDB1751021181890'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_lessons" ("lesson_id" integer NOT NULL, "user_id" varchar NOT NULL, PRIMARY KEY ("lesson_id", "user_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0512f812ca4dacc72a34f24200" ON "users_lessons" ("lesson_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_9f41d8f2868dce0b18870935e9" ON "users_lessons" ("user_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7b0538c99652d7eb1c3ec9e170" ON "users_courses" ("course_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_b04ebfbec561e2e472e3e9fb25" ON "users_courses" ("user_id") `);
        await queryRunner.query(`DROP INDEX "IDX_0512f812ca4dacc72a34f24200"`);
        await queryRunner.query(`DROP INDEX "IDX_9f41d8f2868dce0b18870935e9"`);
        await queryRunner.query(`CREATE TABLE "temporary_users_lessons" ("lesson_id" integer NOT NULL, "user_id" varchar NOT NULL, CONSTRAINT "FK_0512f812ca4dacc72a34f242006" FOREIGN KEY ("lesson_id") REFERENCES "lessons" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_9f41d8f2868dce0b18870935e9a" FOREIGN KEY ("user_id") REFERENCES "users" ("clerkId") ON DELETE CASCADE ON UPDATE NO ACTION, PRIMARY KEY ("lesson_id", "user_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_users_lessons"("lesson_id", "user_id") SELECT "lesson_id", "user_id" FROM "users_lessons"`);
        await queryRunner.query(`DROP TABLE "users_lessons"`);
        await queryRunner.query(`ALTER TABLE "temporary_users_lessons" RENAME TO "users_lessons"`);
        await queryRunner.query(`CREATE INDEX "IDX_0512f812ca4dacc72a34f24200" ON "users_lessons" ("lesson_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_9f41d8f2868dce0b18870935e9" ON "users_lessons" ("user_id") `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_9f41d8f2868dce0b18870935e9"`);
        await queryRunner.query(`DROP INDEX "IDX_0512f812ca4dacc72a34f24200"`);
        await queryRunner.query(`ALTER TABLE "users_lessons" RENAME TO "temporary_users_lessons"`);
        await queryRunner.query(`CREATE TABLE "users_lessons" ("lesson_id" integer NOT NULL, "user_id" varchar NOT NULL, PRIMARY KEY ("lesson_id", "user_id"))`);
        await queryRunner.query(`INSERT INTO "users_lessons"("lesson_id", "user_id") SELECT "lesson_id", "user_id" FROM "temporary_users_lessons"`);
        await queryRunner.query(`DROP TABLE "temporary_users_lessons"`);
        await queryRunner.query(`CREATE INDEX "IDX_9f41d8f2868dce0b18870935e9" ON "users_lessons" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_0512f812ca4dacc72a34f24200" ON "users_lessons" ("lesson_id") `);
        await queryRunner.query(`DROP INDEX "IDX_b04ebfbec561e2e472e3e9fb25"`);
        await queryRunner.query(`DROP INDEX "IDX_7b0538c99652d7eb1c3ec9e170"`);
